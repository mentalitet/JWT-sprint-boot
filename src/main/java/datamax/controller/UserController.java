package datamax.controller;

import javax.servlet.http.HttpServletRequest;

import datamax.dto.request.RefreshTokenRequestDTO;
import datamax.dto.UserLoginDTO;
...
import datamax.dto.UserDataDTO;
import datamax.dto.response.UserResponseDTO;
...
public class UserController {
  ...
  public ResponseEntity<?> login(@ApiParam("Login User") @RequestBody UserLoginDTO user) {
  ...
  public ResponseEntity<?> register(@ApiParam("Signup User") @RequestBody UserDataDTO user) {
